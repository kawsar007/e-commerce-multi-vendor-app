              ...
              <div className="absolute min-h-[30vh] bg-slate-50 shadow-sm-2 z-[9] p-4">
                {searchData &&
                  searchData.map((i, index) => {
                    ...
                    /* Ex. if d contains the value "Apple iPhone 12 Pro Max", then Product_name will be 
                         "Apple-iPhone-12-Pro-Max".This can be useful for creating clean, 
                         readable URLs for product pages on a website or for search engine optimization(SEO) purposes. 
                      */
            ...
            <div className="fixed w-[60%] bg-[#fff] h-screen top-0 left-0 z-10 overflow-y-scroll">
              ...
              <div className="flex w-full justify-center">
                {!isAuthenticated ? (
                  ...
                  <div>
                    <Link to="/profile">
                    <img src={`${backend_url}${user.avatar}`} alt="" className="w-[60px] h-[60px] rounded-full border-[3px] border-[#26e77a]" />
                    </Link>
                  </div>
                )}
              </div>
